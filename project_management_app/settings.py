...
SECRET_KEY = 'django-insecure-j37@r5igr5yo3a1pst@5xaa609vl&12-3grz5bjahx+v#z0*xx'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'management.context_processors.base_context',
            ],
        },
    },
]
...
# connect to the postgres database on rails
# DATABASES = {
